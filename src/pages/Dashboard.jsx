                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex-1">
                                            <h3 className="font-black text-white text-lg capitalize flex items-center gap-2">
                                                <svg className="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            {invitado.cantAcomp === 1 ? (
                                                <p className="text-sm text-red-400 mt-2 flex items-center gap-2 font-bold">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                                    </svg>
                                                    Con: <span className="text-white capitalize">{invitado.nombreAcomp}</span>
                                                </p>
                                            ) : (
                                        ...
                                        {invitado.asistencia ? (
                                            <span className="px-3 py-1.5 rounded-full bg-green-500/10 text-green-400 text-xs font-black border border-green-500/30 uppercase tracking-wider">
                                                Sí
                                            </span>
                                        ) : (
                                            <span className="px-3 py-1.5 rounded-full bg-red-500/10 text-red-500 text-xs font-black border border-red-500/30 uppercase tracking-wider">
                                                No
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    {invitado.mensaje && (
                                        <div className="bg-neutral-900/50 border border-neutral-700/50 p-4 rounded-xl mb-3">
                                            <div className="flex items-start gap-2">
                                                ...
                                                <p className="text-sm text-neutral-400 italic">"{invitado.mensaje}"</p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {invitado.telefono && (
                                        <a
                                            ...
                                            className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-green-600/10 text-green-400 border border-green-600/30 font-black text-sm hover:bg-green-600/20 transition-all uppercase tracking-wider group"
                                        >
                                            ...
                                            <tr key={invitado.id} className="hover:bg-white/5 transition-colors">
                                                <td className="p-6">
                                                    <div className="flex flex-col gap-2">
                                                        <span className="font-black text-white capitalize text-base">{invitado.nombre}</span>
                                                        {invitado.cantAcomp === 1 ? (
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span className="text-xs text-white font-bold capitalize">{invitado.nombreAcomp}</span>
                                                            </div>
                                                        ) : (
                                                ...
                                                <td className="p-6">
                                                    {invitado.telefono ? (
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-green-600/10 text-green-400 border border-green-600/30 font-bold text-xs hover:bg-green-600/20 transition-all uppercase tracking-wider group"
                                                        >
                                                ...
                                                <td className="p-6">
                                                    {invitado.mensaje ? (
                                                        <div className="max-w-xs">
                                                            <p className="text-sm text-neutral-400 italic line-clamp-2">"{invitado.mensaje}"</p>
                                                        </div>
                                                    ) : (
                                                        <span className="text-neutral-700 font-bold">—</span>
                                                    )}
