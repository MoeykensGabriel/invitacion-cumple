                                ...
                                >
                                    ...
                                    {invitado.telefono && (
                                        <div className="flex gap-2 mt-4">
                                            {/* Botón Chat Normal */}
                                            <a
                                                href={`https://wa.me/${inv.telefono}`}
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex-1 bg-neutral-700 text-white py-3 rounded-xl text-xs font-bold uppercase tracking-wider text-center hover:bg-neutral-600 transition-colors"
                                            >
                                                Chat
                                            </a>
